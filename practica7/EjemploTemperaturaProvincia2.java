...
class EjemploTemperaturaProvincia2 {
  public static void main(String[] args) {
    int                numHebras, codProvincia, desp;
    long               t1, t2, tt[];
    double             ts, tp;
    PuebloMaximaMinima2 MaxMin;
...
*/
    ...
    t1 = System.nanoTime();
    MaxMin = new PuebloMaximaMinima2();
    obtenMayorDiferencia_SecuencialDeFichero2(fecha, codProvincia, MaxMin);
    t2 = System.nanoTime();
...
//    }
    ...
    obtenMayorDiferencia_ParaleloDeFichero2 (numHebras, fecha, MaxMin);
...
//    }
  ...
  // --------------------------------------------------------------------------
  public static void obtenMayorDiferencia_SecuencialAFichero2 (String fecha, int codProvincia,
                                                              PuebloMaximaMinima2 MaxMin) {
    ...
    try
    {
      ...
      for (int i=codProvincia*1000; i<(codProvincia+1)*1000; i++){
        if (ProcesaPueblo2(fecha, i, MaxMin, false) == true) {
          pw.println(i);
        }
      }
    } catch (Exception e) {
  ...
  public static void obtenMayorDiferencia_SecuencialDeFichero2 (String fecha, int codProvincia,
                                                               PuebloMaximaMinima2 maxMin) {
    File           archivo = null;
    FileReader     fr      = null;
    ...
    try
    {
      ...
      while( ( linea = br.readLine() ) != null ) {
        ...
        ProcesaPueblo2(fecha, codPueblo, maxMin, false);
      }
    } catch (Exception e) {
      e.printStackTrace();
    }finally{
  ...
  public static void obtenMayorDiferencia_ParaleloDeFichero2(int numHebras, String fecha, PuebloMaximaMinima2 maxMin) {
          File           archivo = null;
          FileReader     fr      = null;
          BufferedReader br      = null;
          ...
          try
          {
                  ...
                  while( ( linea = br.readLine() ) != null ) {
                          int codPueblo = Integer.parseInt(linea);
                          exec.execute(new Tarea2(codPueblo, fecha, maxMin));
  ...
  // --------------------------------------------------------------------------
  public static boolean ProcesaPueblo2 (String fecha, int codPueblo, PuebloMaximaMinima2 maxMin,
                                       boolean imprime) {
    URL            url;
    InputStream    is = null;
    BufferedReader br;
...
class Tarea2 implements Runnable{
        ...
        public Tarea2(int pueblo, String fecha, PuebloMaximaMinima2 MaxMin) {
                this.pueblo=pueblo;
                this.fecha=fecha;
                this.MaxMin=MaxMin;
        ...
        public void run() {
        	 EjemploTemperaturaProvincia2.ProcesaPueblo2(fecha, pueblo, MaxMin,false);
        }
