...
// ============================================================================
  ...
  public static void main( String args[] ) {
    ...
    */
    ...
    Map<String, Integer> hmCuentaPalabrasSynchronized = Collections.synchronizedMap(hmCuentaPalabras);

    MiHebra_1[] hebras = new MiHebra_1[numHebras];
    for(int i = 0; i<numHebras;i++){
      hebras[i]=new MiHebra_1(i, numHebras,hmCuentaPalabrasSynchronized,vectorLineas);
      hebras[i].start();
    }
    for (int i = 0; i<numHebras;i++){
      try {
    ...
    imprimePalabraMasUsadaYVeces( hmCuentaPalabrasSynchronized );
  ...
  // -------------------------------------------------------------------------
  public synchronized static void contabilizaPalabraSynchronized(
...
class MiHebra_1 extends Thread{
  ...
  public MiHebra_1(int id, int nHebras, Map<String,Integer> mapa, Vector<String> vectorLineas){
    this.id=id;
  ...
  public void run(){
    ...
    for(int i = id; i<vectorLineas.size(); i+=nHebras){
      ...
      for( int j = 0; j < palabras.length; j++ ) {
        ...
        palabraActual = palabras[ j ].trim();
        if( palabraActual.length() > 0 ) {
          EjemploPalabraMasUsada1a.contabilizaPalabraSynchronized( mapa, palabraActual );
        }
      }
    }
  }
